...
def go(args):
    ...
    trainval_local_path = run.use_artifact(args.trainval_artifact).file(root='./artifacts/trainval_artifact.csv')
    # YOUR CODE HERE
    ######################################
    ...
    # YOUR CODE HERE
    model_artifact = wandb.Artifact(name=args.output_artifact,
                              type="model_export", description="random forest model pipeline",
                              metadata=rf_config)
    model_artifact.add_dir(local_path="random_forest_dir")
